...
end_dock_map<-leaflet(data = docking_station_end) %>% addTiles() %>%
...
start_dock_map<-leaflet(data = docking_station_start) %>% addTiles() %>%
...
bscols(
filter_select("Magnitude Level", "Magnitude Level", start_dock_map, ~dock_count)
  )
bscols(start_dock_map)
