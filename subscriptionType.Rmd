...
```{r}
# create function for top 10 popular start stations
...
PerishPlot<-ggplot(poptimePershing) + 
  ...
  geom_line(aes(x = stophour,y = countstop, color="end time")) + labs( x = "Time", y = "Frequency of rentals and returns", color = "Legend") +
